# Code for Fig S4: relationship between log of determinant of a correlation matrix 
# and the maximum squared correlation for randomly generated correlation matrices
